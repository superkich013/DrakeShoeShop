        ...
        <div class="container-checkout">
            ...
            <div class="left">
                <div class="left-cont">
                    ...
                    <input name="name" placeholder="Họ và tên" value="${user.fullname}"/>
                    <input name="phone" placeholder="Số điện thoại"value="0${user.phone}"/>
                    <input name="email" placeholder="Email" value="${user.email}"/>
                    <input name="address" placeholder="Địa chỉ nhận hàng" value="${user.address}"/>
